...
# # Loading Models
# model1 = tf.lite.Interpreter(model_path='model1_lite.tflite')
# model2 = tf.lite.Interpreter(model_path='model2_lite.tflite')
# model3 = tf.lite.Interpreter(model_path='model3_lite.tflite')
# model4 = tf.lite.Interpreter(model_path='model4_lite.tflite')
# model5 = tf.lite.Interpreter(model_path='model5_lite.tflite')
# model6 = tf.lite.Interpreter(model_path='model6_lite.tflite')
# model8 = tf.lite.Interpreter(model_path='model8_lite.tflite')
# model9 = tf.lite.Interpreter(model_path='model9_lite.tflite')
# model10 = tf.lite.Interpreter(model_path='model10_lite.tflite')
# model12 = tf.lite.Interpreter(model_path='model12_lite.tflite')
# model13 = tf.lite.Interpreter(model_path='model13_lite.tflite')
# model14 = tf.lite.Interpreter(model_path='model14_lite.tflite')
# model15 = tf.lite.Interpreter(model_path='model15_lite.tflite')
# model16 = tf.lite.Interpreter(model_path='model16_lite.tflite')
# model1.allocate_tensors()
# model2.allocate_tensors()
# model3.allocate_tensors()
# model4.allocate_tensors()
# model5.allocate_tensors()
# model6.allocate_tensors()
# model8.allocate_tensors()
# model9.allocate_tensors()
# model10.allocate_tensors()
# model12.allocate_tensors()
# model13.allocate_tensors()
# model14.allocate_tensors()
# model15.allocate_tensors()
